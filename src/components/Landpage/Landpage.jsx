    ...
    <main className='landpage'>
        ...
        <div className='landpage-content-wrapper'>
            ...
            >
                ...
                >
                   Manage Your Investments Easily And Efficiently
                </motion.h1>
                <motion.p
                    initial={{y:45, opacity:0}}
                    animate={{y:0, opacity:1}}
                ...
                >
                    let us take control of maximizing your income and managing your investments efficiently for awesome investment returns and let you take a view on the big picture in global markets.
                </motion.p>
              ...
              <div className="landpage-img-container">
                  <motion.img src="/Pro-Max.png.webp" alt="" className='phone'
                    initial={{ y: 45, opacity: 0 }}
                    animate={{y:0, opacity:1}}
                    transition={{duration:0.65,delay:0.6}}/>
                  <motion.img src="/Group-23-1.svg" alt="" className="floating-container-img1"
                  initial={{y:45, opacity:0}}
                    animate={{y:0, opacity:1}}
                    transition={{duration:0.65,delay:0.8}}/>
                  <motion.img src="/Group-211.svg" alt="" className="floating-container-img2"
                  initial={{y:45, opacity:0}}
                    animate={{y:0, opacity:1}}
                    transition={{duration:0.65,delay:1.0}}/>
                  <motion.img src="/Group-22.svg" alt="" className="floating-container-img3"
                  initial={{y:45, opacity:0}}
                    animate={{y:0, opacity:1}}
